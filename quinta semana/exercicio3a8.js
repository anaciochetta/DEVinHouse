...
class Pedidos {
     ...
     adcionarProduto (produto){
        this.listaProdutos.push(produto)} //adciona produtos dentro da lista de produtos
...
meuPedido.listaProdutos.forEach(produto => console.log(`Produto: ${produto.nome} | Valor un: ${produto.preco} | Total: ${produto.preco * produto.quantidade}`))
console.log(`Preço total do Pedido de ${meuPedido.nomeCliente}: R$${meuPedido.calcularTotal()}`)
