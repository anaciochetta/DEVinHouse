...
namespace semanaOnze.Data
{
    ...
    [Migration("20220812141232_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("semanaOnze.Models.CarteiraTrabalho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("semanaOnze.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("semanaOnze.Models.ClienteVacina", b =>
                {
                    b.Property<int>("ClienteId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("semanaOnze.Models.Exame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("semanaOnze.Models.Vacina", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("semanaOnze.Models.CarteiraTrabalho", b =>
                {
                    b.HasOne("semanaOnze.Models.Cliente", "Cliente")
                        .WithOne("CarteiraTrabalho")
                        .HasForeignKey("semanaOnze.Models.CarteiraTrabalho", "ClienteId")
            ...
            modelBuilder.Entity("semanaOnze.Models.ClienteVacina", b =>
                {
                    ...
                    b.HasOne("semanaOnze.Models.Vacina", "Vacina")
                        .WithMany()
